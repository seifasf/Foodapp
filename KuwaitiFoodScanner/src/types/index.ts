...
export interface Restaurant {
  ...
  // New fields for price comparison
  deliveryApps: string[]; // Array of delivery app IDs
  isPriceComparisonEnabled: boolean;
}
...
export interface PriceComparison {
  ...
  isAvailable: boolean;
  lastUpdated: Date;
  submittedBy: string; // User ID who submitted this price
  trustScore: number; // 0-100 based on user reputation
  verified: boolean;
}
...
export type RootStackParamList = {
  ...
  Cart: undefined;
  PriceComparison: { cartId: string };
  PriceSubmission: { menuItemId: string; restaurantId: string };
};
...
export const DELIVERY_APPS: FoodApp[] = [
  {
    id: 'talabat',
    name: 'Talabat',
    nameAr: 'طلبات',
    logoUrl: 'https://via.placeholder.com/100x100/FF6B35/FFFFFF?text=T',
    isActive: true,
  },
  {
    id: 'jahez',
    name: 'Jahez',
    nameAr: 'جاهز',
    logoUrl: 'https://via.placeholder.com/100x100/2E7D32/FFFFFF?text=J',
    isActive: true,
  },
  {
    id: 'deliveroo',
    name: 'Deliveroo',
    nameAr: 'دليفرو',
    logoUrl: 'https://via.placeholder.com/100x100/00CCBC/FFFFFF?text=D',
    isActive: true,
  },
  {
    id: 'carriage',
    name: 'Carriage',
    nameAr: 'كريج',
    logoUrl: 'https://via.placeholder.com/100x100/FFD700/000000?text=C',
    isActive: true,
  },
  {
    id: 'zomato',
    name: 'Zomato',
    nameAr: 'زوماتو',
    logoUrl: 'https://via.placeholder.com/100x100/FF5722/FFFFFF?text=Z',
    isActive: true,
  },
];
